...
public class KeyguardPatternView extends KeyguardInputView implements AppearAnimationCreator<LockPatternView.CellState> {
    ...
    public final void createAnimation(Object obj, long j, long j2, float f, boolean z, Interpolator interpolator, Runnable runnable) {
        ...
        if (runnable != null) {
            ...
            AppearAnimationUtils.createAnimation(view, j, j2, f, z, interpolator, (Runnable) null);
        }
    }
    ...
    public final void startAppearAnimation() {
        ...
        AppearAnimationUtils.startTranslationYAnimation(this, 0, 500, 0.0f, appearAnimationUtils2.mInterpolator, new AnimatorListenerAdapter(18) {
...
*/
        ...
        if (!TextUtils.isEmpty(this.mSecurityMessageDisplay.getText())) {
            ...
            AppearAnimationUtils.createAnimation((View) keyguardMessageArea, 0, 220, f, true, appearAnimationUtils4.mInterpolator, (Runnable) null);
        }
    }
    ...
    public final void onDevicePostureChanged(int i) {
        ...
        constraintSet.get(C1777R.C1779id.pattern_top_guideline).layout.guidePercent = f;
        constraintSet.get(C1777R.C1779id.pattern_top_guideline).layout.guideEnd = -1;
        constraintSet.get(C1777R.C1779id.pattern_top_guideline).layout.guideBegin = -1;
    ...
    public final void onFinishInflate() {
        ...
        this.mLockPatternView = findViewById(C1777R.C1779id.lockPatternView);
        this.mEcaView = findViewById(C1777R.C1779id.keyguard_selector_fade_container);
        this.mContainer = (ConstraintLayout) findViewById(C1777R.C1779id.pattern_container);
    }
