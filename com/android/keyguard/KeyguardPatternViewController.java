...
public final class KeyguardPatternViewController extends KeyguardInputViewController<KeyguardPatternView> {
    public C05102 mCancelPatternRunnable = new Runnable() {
        public final void run() {
            KeyguardPatternViewController.this.mLockPatternView.clearPattern();
        }
    };
    public CountDownTimer mCountdownTimer;
    public C05091 mEmergencyButtonCallback = new EmergencyButtonController.EmergencyButtonCallback() {
    ...
    public final KeyguardPatternViewController$$ExternalSyntheticLambda2 mPostureCallback = new KeyguardPatternViewController$$ExternalSyntheticLambda2(this);
    ...
    public class UnlockPatternListener implements LockPatternView.OnPatternListener {
        ...
        public final void onPatternChecked(int i, boolean z, int i2, boolean z2) {
            ...
            if (i2 == 0) {
                KeyguardPatternViewController.this.mMessageAreaController.setMessage((int) C1777R.string.kg_wrong_pattern);
                KeyguardPatternViewController keyguardPatternViewController = KeyguardPatternViewController.this;
                keyguardPatternViewController.mLockPatternView.postDelayed(keyguardPatternViewController.mCancelPatternRunnable, 2000);
            }
        }
    }
    ...
    public final void handleAttemptLockout(long j) {
        ...
        this.mCountdownTimer = new CountDownTimer(((long) Math.ceil(((double) (j - SystemClock.elapsedRealtime())) / 1000.0d)) * 1000) {
            public final void onTick(long j) {
                ...
                KeyguardPatternViewController keyguardPatternViewController = KeyguardPatternViewController.this;
                keyguardPatternViewController.mMessageAreaController.setMessage((CharSequence) PluralsMessageFormatter.format(((KeyguardPatternView) keyguardPatternViewController.mView).getResources(), hashMap, C1777R.string.kg_too_many_failed_attempts_countdown));
            }
            ...
            public final void onFinish() {
                ...
                keyguardPatternViewController.mMessageAreaController.setMessage((CharSequence) "");
            }
        }.start();
    }
    ...
    public final void onViewAttached() {
        ...
        C05091 r2 = this.mEmergencyButtonCallback;
        Objects.requireNonNull(emergencyButtonController);
        emergencyButtonController.mEmergencyButtonCallback = r2;
        View findViewById = ((KeyguardPatternView) this.mView).findViewById(C1777R.C1779id.cancel_button);
    ...
    public final void showPromptReason(int i) {
        ...
        if (i == 1) {
            this.mMessageAreaController.setMessage((int) C1777R.string.kg_prompt_reason_restart_pattern);
        } else if (i == 2) {
            this.mMessageAreaController.setMessage((int) C1777R.string.kg_prompt_reason_timeout_pattern);
        } else if (i == 3) {
            this.mMessageAreaController.setMessage((int) C1777R.string.kg_prompt_reason_device_admin);
        } else if (i == 4) {
            this.mMessageAreaController.setMessage((int) C1777R.string.kg_prompt_reason_user_request);
        } else if (i == 6) {
            this.mMessageAreaController.setMessage((int) C1777R.string.kg_prompt_reason_timeout_pattern);
        } else if (i != 7) {
            this.mMessageAreaController.setMessage((int) C1777R.string.kg_prompt_reason_timeout_pattern);
    ...
    public final boolean startDisappearAnimation(Runnable runnable) {
        ...
        float f3 = -disappearAnimationUtils2.mStartTranslation;
        ...
        KeyguardPatternView keyguardPatternView2 = keyguardPatternView;
        AppearAnimationUtils.startTranslationYAnimation(keyguardPatternView2, 0, (long) (300.0f * f2), f3, disappearAnimationUtils3.mInterpolator, new AnimatorListenerAdapter(21) {
...
*/
        ...
        float f4 = (-disappearAnimationUtils4.mStartTranslation) * 3.0f;
        ...
        AppearAnimationUtils.createAnimation((View) keyguardPatternView.mSecurityMessageDisplay, 0, (long) (f2 * 200.0f), f4, false, disappearAnimationUtils5.mInterpolator, (Runnable) null);
        return true;
    }
    ...
    public KeyguardPatternViewController(KeyguardPatternView keyguardPatternView, KeyguardUpdateMonitor keyguardUpdateMonitor, KeyguardSecurityModel.SecurityMode securityMode, LockPatternUtils lockPatternUtils, KeyguardSecurityCallback keyguardSecurityCallback, LatencyTracker latencyTracker, FalsingCollector falsingCollector, EmergencyButtonController emergencyButtonController, KeyguardMessageAreaController.Factory factory, DevicePostureController devicePostureController) {
        ...
        this.mLockPatternView = keyguardPatternView.findViewById(C1777R.C1779id.lockPatternView);
