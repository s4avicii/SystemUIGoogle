...
public final class SmartspaceDedupingCoordinator_Factory implements Factory<SmartspaceDedupingCoordinator> {
    ...
    public final Object get() {
        return new SmartspaceDedupingCoordinator(this.statusBarStateControllerProvider.get(), this.smartspaceControllerProvider.get(), this.notificationEntryManagerProvider.get(), this.notificationLockscreenUserManagerProvider.get(), this.notifPipelineProvider.get(), this.executorProvider.get(), this.clockProvider.get());
    }
