...
public abstract class ExpandableOutlineView extends ExpandableView {
    public static final AnimatableProperty.C12216 BOTTOM_ROUNDNESS = new AnimatableProperty(C1777R.C1779id.bottom_roundess_animator_end_tag, C1777R.C1779id.bottom_roundess_animator_start_tag, C1777R.C1779id.bottom_roundess_animator_tag, new FloatProperty<Object>("bottomRoundness", WifiPickerTracker$$ExternalSyntheticLambda9.INSTANCE$1, ExpandableOutlineView$$ExternalSyntheticLambda1.INSTANCE) {
...
*/
    ...
    public static final AnimatableProperty.C12216 TOP_ROUNDNESS;
    ...
    public final C13151 mProvider;
    public float[] mTmpCornerRadii;
    public Path mTmpPath;
    ...
    static {
        ...
        AnimatableProperty.C12227 r2 = AnimatableProperty.f80Y;
        TOP_ROUNDNESS = new AnimatableProperty(C1777R.C1779id.top_roundess_animator_end_tag, C1777R.C1779id.top_roundess_animator_start_tag, C1777R.C1779id.top_roundess_animator_tag, new FloatProperty<Object>("topRoundness", peopleSpaceUtils$$ExternalSyntheticLambda4, expandableOutlineView$$ExternalSyntheticLambda0) {
            public final /* synthetic */ Function val$getter;
            public final /* synthetic */ BiConsumer val$setter;
...
*/
    ...
    public final Path getClipPath(boolean z) {
        ...
        if (!this.mCustomOutline) {
            ...
            i3 = Math.max(this.mMinimumHeightForClipping, Math.max(this.mActualHeight - this.mClipBottomAmount, (int) (((float) i) + f)));
        } else {
            Rect rect = this.mOutlineRect;
            i2 = rect.left;
            i = rect.top;
        ...
        fArr[6] = f2;
        fArr[7] = f2;
        path.addRoundRect((float) i2, (float) i, (float) i4, (float) i3, fArr, Path.Direction.CW);
    ...
    public final boolean setBottomRoundness(float f, boolean z) {
        ...
        AnimatableProperty.C12216 r1 = BOTTOM_ROUNDNESS;
    ...
    public final boolean setTopRoundness(float f, boolean z) {
        ...
        AnimatableProperty.C12216 r1 = TOP_ROUNDNESS;
        Objects.requireNonNull(r1);
        if (getTag(r1.val$animatorTag) != null) {
            z2 = true;
        }
    ...
    public ExpandableOutlineView(Context context, AttributeSet attributeSet) {
        ...
        C13151 r1 = new ViewOutlineProvider() {
            public final void getOutline(View view, Outline outline) {
                int i;
                ExpandableOutlineView expandableOutlineView = ExpandableOutlineView.this;
                if (!expandableOutlineView.mCustomOutline) {
                    Objects.requireNonNull(expandableOutlineView);
                    if (expandableOutlineView.mCurrentTopRoundness == 0.0f) {
                        ExpandableOutlineView expandableOutlineView2 = ExpandableOutlineView.this;
                        Objects.requireNonNull(expandableOutlineView2);
                        if (expandableOutlineView2.mCurrentBottomRoundness == 0.0f) {
                            ExpandableOutlineView expandableOutlineView3 = ExpandableOutlineView.this;
                            if (!expandableOutlineView3.mAlwaysRoundBothCorners) {
                                if (!expandableOutlineView3.mDismissUsingRowTranslationX) {
                                    i = (int) expandableOutlineView3.getTranslation();
                                } else {
                                    i = 0;
                                }
                                int max = Math.max(i, 0);
                                ExpandableOutlineView expandableOutlineView4 = ExpandableOutlineView.this;
                                int i2 = expandableOutlineView4.mClipTopAmount;
                                Objects.requireNonNull(expandableOutlineView4);
                                int i3 = i2 + 0;
                                int width = ExpandableOutlineView.this.getWidth();
                                ExpandableOutlineView expandableOutlineView5 = ExpandableOutlineView.this;
                                Objects.requireNonNull(expandableOutlineView5);
                                outline.setRect(max, i3, Math.min(i, 0) + width, Math.max(expandableOutlineView5.mActualHeight - ExpandableOutlineView.this.mClipBottomAmount, i3));
    ...
    private void initDimens() {
        ...
        this.mOutlineRadius = resources.getDimension(C1777R.dimen.notification_shadow_radius);
        boolean z = resources.getBoolean(C1777R.bool.config_clipNotificationsToOutline);
        this.mAlwaysRoundBothCorners = z;
        if (!z) {
            this.mOutlineRadius = (float) resources.getDimensionPixelSize(C1777R.dimen.notification_corner_radius);
        }
