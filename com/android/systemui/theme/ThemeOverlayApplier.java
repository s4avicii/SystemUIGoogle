...
public final class ThemeOverlayApplier implements Dumpable {
    ...
    public final void dump(FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        StringBuilder m = VendorAtomValue$$ExternalSyntheticOutline1.m1m("mTargetPackageToCategories=");
    ...
    public final void setEnabled(OverlayManagerTransaction.Builder builder, OverlayIdentifier overlayIdentifier, String str, int i, Set<UserHandle> set, boolean z, boolean z2) {
        if (DEBUG) {
            StringBuilder m = VendorAtomValue$$ExternalSyntheticOutline1.m1m("setEnabled: ");
            m.append(overlayIdentifier.getPackageName());
            m.append(" category: ");
            m.append(str);
            m.append(": ");
            KeyguardUpdateMonitor$18$$ExternalSyntheticOutline0.m29m(m, z, "ThemeOverlayApplier");
        }
