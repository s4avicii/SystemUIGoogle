...
public final /* synthetic */ class NavBarTuner$$ExternalSyntheticLambda1 implements Preference.OnPreferenceChangeListener {
    ...
    public final boolean onPreferenceChange(Preference preference, Serializable serializable) {
        ...
        Preference preference2 = this.f$3;
        ListPreference listPreference2 = this.f$4;
        int[][] iArr = NavBarTuner.ICONS;
        Objects.requireNonNull(navBarTuner);
        navBarTuner.mHandler.post(new NavBarTuner$$ExternalSyntheticLambda7(navBarTuner, str, listPreference, preference2, listPreference2));
        return true;
    }
}
