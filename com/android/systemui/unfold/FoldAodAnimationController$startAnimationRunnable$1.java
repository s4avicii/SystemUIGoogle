...
public final class FoldAodAnimationController$startAnimationRunnable$1 implements Runnable {
    ...
    public final void run() {
        ...
        C16911 r1 = new Runnable() {
            public final void run() {
                foldAodAnimationController.setAnimationState(false);
            }
        };
        Objects.requireNonNull(notificationPanelViewController);
        notificationPanelViewController.mView.animate().translationX(0.0f).alpha(1.0f).setDuration(600).setInterpolator(Interpolators.EMPHASIZED_DECELERATE).setListener(new AnimatorListenerAdapter(r1) {
            public final /* synthetic */ Runnable val$endAction;

            public final void onAnimationCancel(
/*
Method generation error in method: com.android.systemui.statusbar.phone.NotificationPanelViewController.15.onAnimationCancel(android.animation.Animator):void, dex: classes.dex
            jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.android.systemui.statusbar.phone.NotificationPanelViewController.15.onAnimationCancel(android.animation.Animator):void, class status: UNLOADED
...
/*
Method generation error in method: com.android.systemui.statusbar.phone.NotificationPanelViewController.15.onAnimationEnd(android.animation.Animator):void, dex: classes.dex
            jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.android.systemui.statusbar.phone.NotificationPanelViewController.15.onAnimationEnd(android.animation.Animator):void, class status: UNLOADED
            	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
            	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
            	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
            	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
...
*/
        ...
        if (animatableClockController != null) {
            ...
            keyguardClockSwitchController.mLargeClockViewController.animateFoldAppear();
        }
    }
}
