...
public class UsbContaminantActivity extends Activity implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        if (view == this.mEnableUsb) {
            try {
                ...
                Toast.makeText(this, C1777R.string.usb_port_enabled, 0).show();
            } catch (Exception e) {
    ...
    public final void onCreate(Bundle bundle) {
        ...
        setContentView(C1777R.layout.contaminant_dialog);
        this.mUsbPort = getIntent().getParcelableExtra("port").getUsbPort((UsbManager) getSystemService(UsbManager.class));
        this.mLearnMore = (TextView) findViewById(C1777R.C1779id.learnMore);
        this.mEnableUsb = (TextView) findViewById(C1777R.C1779id.enableUsb);
        this.mGotIt = (TextView) findViewById(C1777R.C1779id.gotIt);
        this.mTitle = (TextView) findViewById(C1777R.C1779id.title);
        this.mMessage = (TextView) findViewById(C1777R.C1779id.message);
        this.mTitle.setText(getString(C1777R.string.usb_contaminant_title));
        this.mMessage.setText(getString(C1777R.string.usb_contaminant_message));
        this.mEnableUsb.setText(getString(C1777R.string.usb_disable_contaminant_detection));
        this.mGotIt.setText(getString(C1777R.string.got_it));
        this.mLearnMore.setText(getString(C1777R.string.learn_more));
