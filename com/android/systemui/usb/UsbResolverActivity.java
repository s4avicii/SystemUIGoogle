...
public class UsbResolverActivity extends ResolverActivity {
    ...
    /* JADX WARNING: type inference failed for: r1v0, types: [android.content.Context, com.android.internal.app.ResolverActivity, com.android.systemui.usb.UsbResolverActivity] */
    ...
    public final void onCreate(Bundle bundle) {
        ...
        if (this.mDevice == null) {
            checkBox.setText(C1777R.string.always_use_accessory);
        } else {
            checkBox.setText(C1777R.string.always_use_device);
        }
    }
}
