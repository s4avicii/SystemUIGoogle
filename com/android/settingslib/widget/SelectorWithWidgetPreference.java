...
public class SelectorWithWidgetPreference extends CheckBoxPreference {
    ...
    public SelectorWithWidgetPreference(Context context, AttributeSet attributeSet) {
        ...
        this.mLayoutResId = C1777R.layout.preference_selector_with_widget;
    ...
    public final void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        ...
        this.mExtraWidget = (ImageView) preferenceViewHolder.findViewById(C1777R.C1779id.selector_extra_widget);
        View findViewById3 = preferenceViewHolder.findViewById(C1777R.C1779id.selector_extra_widget_container);
