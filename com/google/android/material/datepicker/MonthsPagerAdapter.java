...
public final class MonthsPagerAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(LinearLayout linearLayout, boolean z) {
            super(linearLayout);
            TextView textView = (TextView) linearLayout.findViewById(C1777R.C1779id.month_title);
            this.monthTitle = textView;
            WeakHashMap<View, ViewPropertyAnimatorCompat> weakHashMap = ViewCompat.sViewPropertyAnimatorMap;
            new ViewCompat.AccessibilityViewProperty<Boolean>() {
                public final void frameworkSet(
/*
Method generation error in method: androidx.core.view.ViewCompat.4.frameworkSet(android.view.View, java.lang.Object):void, dex: classes.dex
                jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: androidx.core.view.ViewCompat.4.frameworkSet(android.view.View, java.lang.Object):void, class status: UNLOADED
...
/*
Method generation error in method: androidx.core.view.ViewCompat.4.shouldUpdate(java.lang.Object, java.lang.Object):boolean, dex: classes.dex
                jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: androidx.core.view.ViewCompat.4.shouldUpdate(java.lang.Object, java.lang.Object):boolean, class status: UNLOADED
                	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
                	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
                	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
                	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
...
/*
Method generation error in method: androidx.core.view.ViewCompat.4.frameworkGet(android.view.View):java.lang.Object, dex: classes.dex
                jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: androidx.core.view.ViewCompat.4.frameworkGet(android.view.View):java.lang.Object, class status: UNLOADED
                	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
                	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
                	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
                	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
...
*/
            ...
            this.monthGrid = (MaterialCalendarGridView) linearLayout.findViewById(C1777R.C1779id.month_grid);
            if (!z) {
    ...
    public final int getItemCount() {
        ...
        return calendarConstraints2.monthSpan;
    }
    ...
    public final void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
        ...
        final MaterialCalendarGridView materialCalendarGridView = (MaterialCalendarGridView) viewHolder2.monthGrid.findViewById(C1777R.C1779id.month_grid);
        if (materialCalendarGridView.getAdapter() == null || !month2.equals(materialCalendarGridView.getAdapter().month)) {
        ...
        materialCalendarGridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public final void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
                ...
                if (z) {
                    ...
                    MaterialCalendar.C19963 r1 = (MaterialCalendar.C19963) onDayClickListener;
                    Objects.requireNonNull(r1);
                    CalendarConstraints calendarConstraints = MaterialCalendar.this.calendarConstraints;
                    Objects.requireNonNull(calendarConstraints);
                    if (calendarConstraints.validator.isValid(longValue)) {
    ...
    public MonthsPagerAdapter(ContextThemeWrapper contextThemeWrapper, DateSelector dateSelector2, CalendarConstraints calendarConstraints2, MaterialCalendar.C19963 r8) {
        int i;
        Objects.requireNonNull(calendarConstraints2);
        Month month = calendarConstraints2.start;
        ...
        if (month.firstOfMonth.compareTo(month3.firstOfMonth) > 0) {
            ...
            int dimensionPixelSize = contextThemeWrapper.getResources().getDimensionPixelSize(C1777R.dimen.mtrl_calendar_day_height) * i2;
            if (MaterialDatePicker.isFullscreen(contextThemeWrapper)) {
                i = contextThemeWrapper.getResources().getDimensionPixelSize(C1777R.dimen.mtrl_calendar_day_height);
            } else {
                i = 0;
            }
    ...
    public final RecyclerView.ViewHolder onCreateViewHolder(RecyclerView recyclerView, int i) {
        LinearLayout linearLayout = (LinearLayout) LayoutInflater.from(recyclerView.getContext()).inflate(C1777R.layout.mtrl_calendar_month_labeled, recyclerView, false);
