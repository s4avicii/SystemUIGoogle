...
public class ScaleFrameLayout extends FrameLayout {
    ...
    public final void onMeasure(int i, int i2) {
        ...
        if (i3 != 0) {
            i = View.MeasureSpec.makeMeasureSpec((int) ((((float) View.MeasureSpec.getSize(i)) / f) + 0.5f), View.MeasureSpec.getMode(i));
        }
        float f2 = this.mLayoutScaleY;
        if (f2 != 1.0f) {
            i2 = View.MeasureSpec.makeMeasureSpec((int) ((((float) View.MeasureSpec.getSize(i2)) / f2) + 0.5f), View.MeasureSpec.getMode(i2));
        }
        super.onMeasure(i, i2);
