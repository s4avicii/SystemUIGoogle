...
public final class StaggeredGridDefault extends StaggeredGrid {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:81:0x0107 A[LOOP:2: B:81:0x0107->B:95:0x012b, LOOP_START, PHI: r6 r9 r10 
      PHI: (r6v9 int) = (r6v3 int), (r6v12 int) binds: [B:80:0x0105, B:95:0x012b] A[DONT_GENERATE, DONT_INLINE]
      PHI: (r9v7 int) = (r9v5 int), (r9v8 int) binds: [B:80:0x0105, B:95:0x012b] A[DONT_GENERATE, DONT_INLINE]
    ...
    public final int findRowMax(boolean z, int i, int[] iArr) {
        int i2;
        int edge = ((GridLayoutManager.C02232) this.mProvider).getEdge(i);
        ...
        if (this.mReversedFlow) {
            ...
            int i12 = edge;
            edge = ((GridLayoutManager.C02232) this.mProvider).getSize(i) + edge;
            i2 = i11;
            while (i9 < this.mNumRows && i10 >= this.mFirstVisibleIndex) {
                ...
                if (i13 != i11) {
                    i9++;
                    int size = ((GridLayoutManager.C02232) this.mProvider).getSize(i10) + i12;
    ...
    public final int findRowMin(boolean z, int i, int[] iArr) {
        ...
        if (this.mReversedFlow) {
            int i4 = 1;
            int i5 = i - 1;
            i2 = edge - ((GridLayoutManager.C02232) this.mProvider).getSize(i);
            int i6 = i3;
            while (i4 < this.mNumRows && i5 >= this.mFirstVisibleIndex) {
                ...
                if (i7 != i6) {
                    i4++;
                    int size = edge - ((GridLayoutManager.C02232) this.mProvider).getSize(i5);
    ...
    public final int getRowMax(int i) {
        ...
        if (this.mReversedFlow) {
            int edge = ((GridLayoutManager.C02232) this.mProvider).getEdge(i3);
        ...
        int edge2 = ((GridLayoutManager.C02232) this.mProvider).getEdge(this.mLastVisibleIndex);
    ...
    public final int getRowMin(int i) {
        ...
        int edge2 = ((GridLayoutManager.C02232) this.mProvider).getEdge(i3);
        if (getLocation(this.mFirstVisibleIndex).row == i) {
            return edge2;
        }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:80:0x00f9 A[LOOP:2: B:80:0x00f9->B:94:0x011d, LOOP_START, PHI: r5 r8 r9 
      PHI: (r5v9 int) = (r5v3 int), (r5v12 int) binds: [B:79:0x00f7, B:94:0x011d] A[DONT_GENERATE, DONT_INLINE]
      PHI: (r8v7 int) = (r8v5 int), (r8v8 int) binds: [B:79:0x00f7, B:94:0x011d] A[DONT_GENERATE, DONT_INLINE]
      PHI: (r9v3 int) = (r9v1 int), (r9v5 int) binds: [B:79:0x00f7, B:94:0x011d] A[DONT_GENERATE, DONT_INLINE]] */
