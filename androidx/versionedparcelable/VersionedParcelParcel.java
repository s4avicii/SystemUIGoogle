...
public final class VersionedParcelParcel extends VersionedParcel {
    ...
    public final VersionedParcelParcel createSubParcel() {
        ...
        return new VersionedParcelParcel(parcel, dataPosition, i, MotionController$$ExternalSyntheticOutline1.m8m(new StringBuilder(), this.mPrefix, "  "), this.mReadCache, this.mWriteCache, this.mParcelizerCache);
    }
