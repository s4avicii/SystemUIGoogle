...
public final class GapWorker implements Runnable {
    ...
    public static C03201 sTaskComparator = new Comparator<Task>() {
        ...
        public final int compare(java.lang.Object r6, java.lang.Object r7) {
            ...
            L_0x0037:
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.recyclerview.widget.GapWorker.C03201.compare(java.lang.Object, java.lang.Object):int");
        }
    };
    ...
    public final void prefetch(long j) {
        ...
        for (int i7 = 0; i7 < this.mTasks.size() && (recyclerView = task.view) != null; i7++) {
            if ((task = this.mTasks.get(i7)).immediate) {
                j2 = Long.MAX_VALUE;
            } else {
                j2 = j;
            }
