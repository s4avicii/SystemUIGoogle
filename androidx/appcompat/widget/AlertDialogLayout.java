        ...
        while (true) {
            if (i9 < childCount) {
                ...
                if (childAt.getVisibility() != 8) {
                    ...
                    if (id == C1777R.C1779id.topPanel) {
                        view = childAt;
                    } else if (id == C1777R.C1779id.buttonPanel) {
                        view2 = childAt;
                    } else if ((id == C1777R.C1779id.contentPanel || id == C1777R.C1779id.customPanel) && view3 == null) {
                        view3 = childAt;
                    }
                }
                i9++;
                ...
                setMeasuredDimension(View.resolveSizeAndState(getPaddingRight() + getPaddingLeft() + i12, i8, i3), View.resolveSizeAndState(paddingBottom, i2, 0));
                if (mode2 != 1073741824) {
